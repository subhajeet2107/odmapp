      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="{{URL::to('/dashboard/index')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="alert alert-success alert-dismissable">
              ...
              Welcome to ODMApp by <a class="alert-link" href="http://codingdroid.com">Subhajeet Dey</a>! This app provides a system to add/update product sheets and products into the sheets, below are some statistics of total inventory.
            </div>
          </div>
        </div><!-- /.row -->
        <div class="row">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">{{ $numsheets}}</p>
                    <p class="announcement-text">Sheets</p>
                  </div>
                </div>
              </div>
              <a href="{{URL::to('/dashboard/sheets')}}">
            ...
            <div class="panel panel-danger">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">{{$numproducts}}</p>
          ...
          <div class="col-lg-3">
            <div class="panel panel-success">
              ...
              <a href="{{URL::to('dashboard/exporter')}}">
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                      Export Products
